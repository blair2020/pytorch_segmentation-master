...
def sliding_predict(model, image, num_classes, flip=True):
    image_size = image.shape  # (batch,3,H,W)
...
def main():
    ...
    assert dataset_type in ['VOC', 'COCO', 'CityScapes', 'ADE20K', 'LLX']  # 加了'LLX'
...
def parse_arguments():
    ...
    # 模型位置
    parser.add_argument('-m', '--model', default='./saved/PSPNet/08-31_02-51/checkpoint-epoch20.pth', type=str,
                        help='Path to the .pth model checkpoint to be used in the prediction')
    # /saved/PSPNet/08-31_02-51/checkpoint-epoch20.pth
    # 测试图像路径
    parser.add_argument('-i', '--images', default='test_images', type=str,
